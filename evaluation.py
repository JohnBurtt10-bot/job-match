...
from config import user_info  # removed GROQ_API_KEY
from constants import co_op_averages
    ...
    try:
        ...
        messages = [
            ...
            "content": (
                ...
                f"• End with a new line: 'Compatibility score out of 100, Salary in CAD adjusted for benefits or bonuses if applicable, Specific category of job (e.g., 'Data Science', 'Frontend Development', Full Stack Development, DevOps, etc.)\n\n"
                ...
                "  - 10 points for decision history if applicable.\n\n"
